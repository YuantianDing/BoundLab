...
from utils import INFINITY, dual_norm, DUAL_INFINITY
...
class Zonotope:
    ...
    def reduce_num_error_terms_box(self, max_num_error_terms: int):
        ...
        if N_others_reduced > 0 and N_others_unreduced < 0:
            print(f'Warning: max num error terms {max_num_error_terms} too low to do a reduction')
            print(f'Warning: reducing instead to min num {self.num_words*self.word_embedding_size + 1} noise symbols')
